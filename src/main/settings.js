...
const DEFAULTS = {
  ...
  // The last version each toast was dismissed for. A person who waved away the
  // news about 0.6.0 should not be told about 0.6.0 again every time they open
  // a window; 0.6.1 is news again. Kept here rather than in localStorage so it
  // survives a cleared cache and can be read back from the file.
  notices: {
    app: '',
    claude: '',
  },
