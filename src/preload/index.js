...
contextBridge.exposeInMainWorld('tandem', {
  ...
  catalog: {
    ...
    mcpCliSignedIn: (name) => ipcRenderer.invoke('catalog:mcpCliSignedIn', { name }),
    mcpAddToken: (name, token) => ipcRenderer.invoke('catalog:mcpAddToken', { name, token }),
    mcpTokenPage: (name) => ipcRenderer.invoke('catalog:mcpTokenPage', { name }),
